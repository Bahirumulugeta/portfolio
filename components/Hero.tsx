    ...
    >
      ...
      <div className="py-16 lg:py-48 flex flex-col-reverse lg:flex-row justify-around gap-10 lg:gap-0">
        <div className="flex flex-col gap-4 md:gap-6 text-left lg:w-1/2 2xl:w-1/3 mx-4 md:mx-6 xl:mx-0">
          ...
          <div className="flex flex-row items-start md:items-center gap-1.5">
            ...
            <Typewriter
              options={{
                ...
                delay: 50,
                wrapperClassName:
                  "text-primary-main dark:text-primary-hover text-lg md:text-2xl font-medium",
                cursorClassName:
                  "text-primary-main dark:text-primary-hover text-lg md:text-2xl",
              }}
            />
          </div>
          ...
          <ScrollLink
            className="w-fit text-sm md:text-base py-2 px-4 cursor-pointer flex items-center gap-1 rounded-md bg-primary-main hover:bg-primary-hover dark:bg-primary-hover hover:dark:bg-primary-main transition-colors group text-white"
            to={"about"}
            offset={-60}
            smooth={true}
            duration={500}
